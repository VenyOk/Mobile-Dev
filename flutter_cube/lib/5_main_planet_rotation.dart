...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  void _onSceneCreated(Scene scene) {
    ...
    _cube = Object(scale: Vector3(2.0, 2.0, 2.0), backfaceCulling: false, fileName: 'obj_files/1.obj');
    final int samples = 5; // <---------- количество кубиков
    final double radius = 8; // <--------  радиус сферы
